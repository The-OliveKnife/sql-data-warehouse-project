    ...
    BEGIN TRY
      ...
      SET @end_time = GETDATE();
        ...
        SELECT
            ...
            AS prd_end_dt   -- Data Enrichment (Calculate end date as one day before next start date)
      ...
      SET @end_time = GETDATE();
        ...
        SELECT
            ...
            CASE WHEN bdate > GETDATE() THEN NULL
                 ELSE bdate
            END bdate,  -- Set future birthdates as NULL
      ...
      SET @end_time = GETDATE();
        ...
        SELECT
            REPLACE(cid, '-', '') AS cid,   -- Data Standardization
            CASE 
                 WHEN (TRIM(cntry)) = 'DE' THEN 'Germany'
                 WHEN (TRIM(cntry)) IN ('US', 'USA') THEN 'United States'
                 WHEN (TRIM(cntry)) IS NULL OR cntry = '' THEN 'N/A'
                 ELSE cntry
            END cntry      -- Normalize & Handle missing data or blank counrty codes
